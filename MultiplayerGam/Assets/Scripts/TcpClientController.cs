    ...
    private void Sync()
    {
        if (Player.DataAvailable())
        {
            ...
            else if (message.MessageType == MessageType.FinishedSync)
            {
                ...
                playerGameObject.GetComponent<MovePlayer>().TcpClientController = this;
                playerGameObject.GetComponent<MovePlayer>().Playable = true;
                playerGameObject.GetComponent<MovePlayer>().enabled = true;
               // playerGameObject.GetComponent<MovePlayer>().PlayerName.text = Player.Name;
